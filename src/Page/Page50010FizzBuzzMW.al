page 50010 "MTB FizzBuzz"
{
    Caption = 'FizzBuzz Number List';
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    SourceTable = "MTB FizzBuzz";
    Editable = false;
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(ClearFBList)               //Azione di pulizia della lista
            {
                ...
                trigger OnAction();
                var
                    FiBuRow: Record "MTB FizzBuzz";   //Variabile FiBuRow inizializzata in questa parte del codice
                begin
